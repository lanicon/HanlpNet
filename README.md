...
- 首次运行需要下载语料库 (https://file.hankcs.com/hanlp/data-for-1.7.5.zip ) 

- 酒店评论情绪分析训练库 (http://file.hankcs.com/corpus/ChnSentiCorp.zip)

- 配置hanlp语料库文件夹，并配置hanlp.properties文件 root=XXXXX/Package/java/hanlp

- 如出现缺少dll将ikvmbin-8.1.5717.0.rar 中相关的openjdk dll复制到bin中
